      ...
      <main className="flex flex-col gap-8 row-start-2 sm:items-start max-w-screen-lg w-full">
        ...
        <div className="flex space-x-14 center w-full">
          ...
          <ul className="list-disc space-y-3 font-light w-1/2">
            ...
            <p className="text-sm text-gray-500">& Minor in 3D-Animation</p>
            <li>Active T3 Secret Clearance granted October 2023</li>
        ...
        <Card link={"/exp_page"}>
          ...
          <div>
            ...
            <ul className="list-disc font-extralight max-w-full space-y-3 pt-2">
              <li><b>2024-Current:</b> Data Scientist @ DoD's <InnerLink link={"https://www.navsea.navy.mil/Home/Warfare-Centers/NSWC-Corona/"} text={"NSWC Corona"}/></li>
              <li>
                <b>2024-Current: </b>
                Student Volunteer @ USC's <InnerLink link={"https://ict.usc.edu/research/labs-groups/virtual-human-therapeutics-lab/"} text="Virtual Human Therapeutics Lab (VHTL)"/>
              ...
              <li>
                <b>2023-2024: </b>
                Student Researcher @ USC's <InnerLink link={"https://liralab.usc.edu/"} text="Learning and Interactive Robot Autonomy Lab (LiraLab)"/>
                <ul className="ml-6 list-disc font-extralight max-w-full">
