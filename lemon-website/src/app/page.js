...
export default function Home() {
  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 row-start-2 sm:items-start max-w-screen-lg">
        {/* main title */}
        <div>
        ...
        <div className="flex w-full space-x-10">
          {/* job */}
          <ul className="list-disc font-extralight w-1/2">
            ...
            {/*     
                • https://www.youtube.com/watch?v=W-ZJ1ijPf8U
                • https://www.youtube.com/watch?v=8xyuCQlTXEg
            ...
            {/* 
                  • https://storymaps.arcgis.com/collections/1e5f963472f4400da19fcb0e3ccfdd5e?item=1
                  • https://www.8thwall.com/blog/post/163144919365/meet-the-winners-time-capsule-challenge
                   */}
          ...
          <ul className="list-disc font-extralight w-1/2">
            ...
            {/* 
            https://viterbischool.usc.edu/news/2023/06/usc-students-advance-augmented-reality-for-artemis-astronauts/
             */}
